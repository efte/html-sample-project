...
```bash
$ cortex install cortex-hybrid-sample --save
```
...
```js
var cortex_hybrid_sample = require('cortex-hybrid-sample');
```
...
### Class: cortex_hybrid_sample(options)
<!-- 
...
Creates a new cortex-hybrid-sample instance.
...
### cortex-hybrid-sample.\<method-name\>(arguments)
